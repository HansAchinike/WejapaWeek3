...
<body style="background-color: #f1d6a9">
	<form action="correct form.php" method="POST" target="_blank">
		<ol>
		<div class="container">
			<div class="row">
				<div class="col">
					...
					placeholder="Enter Mobile" id="Mobile" name="dob" max="10/08/2020"> 
					...
					<select id="Department" name="dept">
						...
						<option value="Administration">Head Of Department</option>
